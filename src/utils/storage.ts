...
export const INITIAL_PLAYERS: Player[] = [
  // レッド・ファルコンズ (RF) - マイチーム
  {
    ...
    age: 18,
    numberHistory: [
      { number: 11, changedAt: Date.now() - 31536000000, note: '2025年度' },
    ],
    createdAt: 1,
  },
  {
  ...
  },
  {
    ...
    age: 16,
    numberHistory: [
      { number: 15, changedAt: Date.now() - 31536000000, note: '2025年度' },
    ],
    createdAt: 3,
  },
  {
  ...
  // ブルー・サンダース (BT)
  { id: 'p_bt_4', teamId: 'team_blue', number: 4, subNumber: 14, name: '魚住 大樹 (C)', position: 'C', notes: 'キャプテン', age: 18, createdAt: 8 },
  { id: 'p_bt_7', teamId: 'team_blue', number: 7, subNumber: 17, name: '仙道 彰', position: 'PG', notes: 'オールラウンダー', age: 17, createdAt: 9 },
  { id: 'p_bt_8', teamId: 'team_blue', number: 8, subNumber: 18, name: '植草 智紀', position: 'PG', notes: 'ディフェンス職人', age: 17, createdAt: 10 },
  { id: 'p_bt_9', teamId: 'team_blue', number: 9, subNumber: 19, name: '越野 宏明', position: 'SG', notes: 'ハッスルプレイ', age: 16, createdAt: 11 },
  { id: 'p_bt_13', teamId: 'team_blue', number: 13, subNumber: 23, name: '福田 吉兆', position: 'PF', notes: 'インサイドオフェンス', age: 17, createdAt: 12 },
  { id: 'p_bt_15', teamId: 'team_blue', number: 15, subNumber: 25, name: '菅平 誠', position: 'C', notes: '', age: 15, createdAt: 13 },
];
...
export const INITIAL_GAMES: Game[] = [
  // 試合1: 進行中
  {
    ...
    rosterSnapshots: {
      p_rf_4: { number: 4, subNumber: 14, name: '赤井 翼 (C)' },
      p_rf_7: { number: 7, subNumber: 17, name: '佐藤 翔太' },
      p_rf_10: { number: 10, subNumber: 20, name: '流川 楓斗' },
      p_rf_11: { number: 11, subNumber: 21, name: '桜庭 蓮' },
      p_rf_14: { number: 14, subNumber: 24, name: '三井 健司' },
      p_rf_15: { number: 15, subNumber: 25, name: '木暮 勇気' },
      p_rf_23: { number: 23, subNumber: 33, name: 'マイケル 高橋' },
    },
    currentQuarter: '2Q',
    status: 'in_progress',
